...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?= $active_nav === NAV_FILE_REQUEST ? 'active' : '' ?>">
                <a href="<?= "{$url}requests/file_request" ?>"><i class="fa fa-envelope"></i> <span>File Request</span></a>
            </li>
            ...
            <?php if(role_is('sv')):?>
            <li class="treeview <?= $active_nav === NAV_VIEW_REQUESTS ? 'active' : '' ?>">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li class="<?= $active_subnav === SUBNAV_PENDING_REQUESTS ? 'active' : '' ?>">
                    <a href="<?= "{$url}requests/view_all?status=p" ?>"><i class="fa fa-circle-o"></i><span class="badge pull-right"><?= pending_count()?></span> Pending</a>

                </li>
                <li class="<?= $active_subnav === SUBNAV_APPROVED_REQUESTS ? 'active' : '' ?>">
                    <a href="<?= "{$url}requests/view_all?status=a" ?>"><i class="fa fa-circle-o"></i> Approved</a>
                </li>
                <li class="<?= $active_subnav === SUBNAV_DISCARDED_REQUESTS ? 'active' : '' ?>">
                    <a href="<?= "{$url}requests/view_all?status=da" ?>"><i class="fa fa-circle-o"></i> Discarded</a>
                </li>
              </ul>
            </li>
            <?php endif;?>
           ...
           <li class="<?= $active_nav === NAV_MY_PAYSLIP ? 'active' : '' ?>">
            ...
            <li class="<?= $active_nav === NAV_MY_ATTENDANCE? 'active' : '' ?>">
                <a href="<?= "{$url}my_attendance" ?>"><i class="fa fa-calendar"></i> <span> My Attendance</span></a>
            </li>
            <li class="<?= $active_nav === NAV_TRACK_REQUESTS ? 'active' : '' ?>">
                <a href="<?= "{$url}requests/track" ?>"><i class="fa fa-eye"></i> <span> Track Requests</span></a>
            </li>
